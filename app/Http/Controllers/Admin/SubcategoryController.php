...
//        $categories = Category::all();
        // Extraer familias únicas de las categorías
//        $families = $categories->pluck('family')->unique('id');
    ...
    public function destroy(Subcategory $subcategory)
    {
        if ($subcategory->products()->count() > 0){
           session()->flash('swal',[
            'icon' => 'error',
            'title' => '¡Ups!',
            'text' => 'No se puede eliminar la subcategoría ya que tiene productos asociados.',
           ]);
